...
//         <button className="btn btn-success" onClick={() => handleOrder(snack)}>
//           Order
//         </button>
//         <button className="btn btn-danger" onClick={() => handleRemove(snack.id)}>
//           Delete
...
//   return (
//     <div className="col-md-6 mt-3 scroll-container">
...
//             <div className="row mt-0 " >
//               <div className="col-md-2 mt-0"  style={{ background: '#FF8C00', marginRight: '5px' }}>
//                 <div className='mt-4' style={{ height: 70 }}></div>
//                 <h3>Dashboard</h3>
...
//               <div className="col-md-1 border-end mt-0" style={{ background: '#FF8C00',  marginLeft: '5px' }}></div>
